...
print(name1 == "Houminghou")   # True
print(name1 == "Houminghou")   # False
print(name1 != "Houminghou")   # False
print(name1 != "Houminghou")   # True
print()
...
if age >= 18:
    ...
    print("Deny access.")
    print("You must be 18 or older to access this website.")
    print("Program complete.")
    print()    
...
#Nested for Loops
attributes = ['Spicy', 'Sweet', 'Salty']
foods = ['Pizza', 'Burger', 'Noodles']

for attribute in attributes:
    for food in foods:
        print(attribute, food)
